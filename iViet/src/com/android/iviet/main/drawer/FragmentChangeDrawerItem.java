...
public class FragmentChangeDrawerItem extends DrawerItem<Fragment> {

	protected FragmentChangeDrawerItem(int icon, CharSequence title, CharSequence id, CharSequence extra, Fragment param) {
